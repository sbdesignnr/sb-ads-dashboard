...
export const config = {
  ...
  matcher: ["/((?!api/auth|api/public|api/videos/sync|api/leads/scan|api/notifications/run|api/cron/send-emails|api/webhooks/brevo|_next/static|_next/image|favicon.ico|.*\\..*).*)"],
};
